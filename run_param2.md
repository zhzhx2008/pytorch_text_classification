...
nohup python -u run_fine_tuning_huggingface_models.py --model_name /data0/nfs_data/zhaoxi9/pretrained_language_model/huggingface_pretrained_models/hfl_chinese-roberta-wwm-ext --gpu 1 --freeze > nohup_hfl_chinese-roberta-wwm-ext_freeze.out 2>&1 &     dev acc=%  test acc=%
...
nohup python -u run_fine_tuning_huggingface_models.py --model_name /data0/nfs_data/zhaoxi9/pretrained_language_model/huggingface_pretrained_models/hfl_chinese-roberta-wwm-ext-large --gpu 3 --freeze > nohup_hfl_chinese-roberta-wwm-ext-large_freeze.out 2>&1 &     dev acc=%  test acc=%
